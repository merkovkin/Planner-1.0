...
public class Vibor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener SecScreen2 = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Vibor.this, str2.class);
        ...
        View.OnClickListener SecScreen3 = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Vibor.this, str3.class);
                startActivity(intent);
            }
        };
        ...
        View.OnClickListener SecScreen4 = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Vibor.this, str4.class);
                startActivity(intent);
            }
        };
        ...
        View.OnClickListener SecScreen = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Vibor.this, str1.class);
                startActivity(intent);
            }
        };
